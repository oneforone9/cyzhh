...
@TableName(value = "t_event_base")
public class EventBase extends Model<EventBase> {

    private static final long serialVersionUID = -23533009170572726L;
    ...
    /**
     * 案件渠道(1市级交办 2 区级交办 3 自查 4 12345 5 网络上报 6 摄像头抓拍)
     */
