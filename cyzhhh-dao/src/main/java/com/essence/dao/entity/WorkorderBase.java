...
@TableName(value = "t_workorder_base")
public class WorkorderBase extends Model<WorkorderBase> {

    private static final long serialVersionUID = 912559970060481221L;
    ...
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @TableField(value = "reject_time", updateStrategy = FieldStrategy.DEFAULT)
