...
/**
 * @author zhy
 * @since 2022/10/28 14:27
 */
@Data
public class WorkorderNewestEsr extends WorkorderBaseEsr {

    private static final long serialVersionUID = 5850755171691412579L;
    ...
    /**
     * 工单当前状态（1未派发 2未开始 3进行中 4待审核 5已归档 6已终止）
     */
     ...
     * 处理前文件集合
     */
    private List<FileBaseEsr> beforeFileList;
    /**
     * 处理后文件集合
     */
    private List<FileBaseEsr> afterFileList;
    /**
     * 开始巡河时间
     */
