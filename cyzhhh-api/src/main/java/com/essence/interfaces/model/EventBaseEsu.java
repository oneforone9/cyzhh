...
@Data
public class EventBaseEsu extends Esu {

    private static final long serialVersionUID = 840081124620833226L;
    ...
    @AssertTrue(message = "案件渠道请从以下选择[市级交办,区级交办,未诉先办,12345,网络上报, 摄像头抓拍]")
    private boolean isEventChannel() {
        ...
        if (ItemConstant.EVENT_CHANNEL_CITY.equals(this.eventChannel) ||
                ...
                ItemConstant.EVENT_CHANNEL_AI.equals(this.eventChannel)) {
            return true;
        }
        return false;
    }
